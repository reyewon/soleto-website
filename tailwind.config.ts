...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display': ['clamp(3rem, 2rem + 4vw, 5rem)', { lineHeight: '1.05', letterSpacing: '0.02em' }],
        'h1': ['clamp(2.5rem, 1.5rem + 3.5vw, 4.5rem)', { lineHeight: '1.1', letterSpacing: '0.02em' }],
        'h2': ['clamp(2rem, 1.2rem + 2.5vw, 3rem)', { lineHeight: '1.15', letterSpacing: '0.01em' }],
